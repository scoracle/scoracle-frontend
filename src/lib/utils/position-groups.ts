 ...
 */
export function nflSideOfBall(position: string | null | undefined): "offense" | "defense" | "special" | null {
 ...
 */
export function isSamePositionGroup(sport: string, position1: string | undefined | null, position2: string | undefined | null): boolean {
