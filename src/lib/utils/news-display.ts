...
export const NEWS_SCOPE_OPTIONS: ReadonlyArray<{
    value: NewsScope;
    label: string;
}> = [
...
export function newsTrajectoryLabel(trajectory?: string | null, label?: string | null): string | null {
...
export function sourceAttribution(sourceCount?: number | null, sourceNames?: readonly string[] | null): string | null {
