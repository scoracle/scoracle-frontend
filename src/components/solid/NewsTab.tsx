 ...
 * query (src/lib/data/news.server.ts). The fetcher runs on the SSR pass
 * and streams the resolved data inline; client-side navigation hits the
 * same `query()` cache after the route's `preload` warms it on hover.
