...
export default function CrystalBall(props: CrystalBallProps) {
    ...
    // ── Auto-cycle ──────────────────────────────────────────────────────────
    function startCycle() {
        if (reducedMotion || cycleTimer !== undefined)
            return;
    ...
    // ── Render ──────────────────────────────────────────────────────────────
    return (<div class="crystal-ball-container" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
      <div class="logo-wrapper">
        ...
        <div class="crystal-art">
          ...
          <img src={props.mainLogoPath} alt="Scoracle" class="crystal-logo" loading="eager" fetchpriority="high" decoding="async"/>
          ...
          link so the target can't dissolve out from under a click. */}
                  <a class="mover-card" href={profileHref(m())} onMouseEnter={stopCycle} onMouseLeave={startCycle} onFocusIn={stopCycle} onFocusOut={startCycle}>
        ...
        need, and the mist is the picture now. */}
                    ...
                    <span class={["mover-delta", { 'is-up': m().delta > 0, 'is-down': m().delta < 0 }]}>
