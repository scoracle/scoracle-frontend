...
in the local `local/design/` study and are not included in the release.
...
Generated with the built-in image tool. Source subject retained: radiating celestial light. Preview asset: `local/design/momentum-radiant-light-v1.png`.
...
Approved Momentum: `local/design/momentum-radiant-light-v1.png`, edge crop F.

## scouting

Saved asset: `local/design/scouting-engraving-v1.png`
...
Saved asset: `local/design/narratives-engraving-v1.png`
...
Saved asset: `local/design/transfers-engraving-v1.png`
...
Saved asset: `local/design/vibe-engraving-v1.png`
...
Saved asset: `local/design/sigil-engraving-v1.png`
